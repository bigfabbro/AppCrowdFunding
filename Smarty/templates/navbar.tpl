...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" type="text/css">
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-primary">
    <div class="container">
      ...
      <form class="form-inline my-2 my-lg-0" {if $userlogged!='nouser'}style="margin-left:10px" {else} style="margin-left:81px"{/if} action="/AppCrowdFunding/Ricerca/ricerca" method="get">
