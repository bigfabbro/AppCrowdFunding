...
<body style="background-image: url('C:/xampp/htdocs/AppCrowdFunding/Smarty/img/wallpaperRazzo.jpg');background-size:cover;">
  <div class="py-5">
    <div class="container bg-light box-input1">
      <div class="row">
        <div class="col-md-9 p-0 m-0 align-self-center">
          <h1 class="text-center">Campaign's name</h1>
        </div>
        <div class="col-md-3">
          <div class="row">
            ...
            <div class="col-md-6">
              <img class="img-fluid d-block rounded-circle mx-auto" src="https://pingendo.com/assets/photos/wireframe/photo-1.jpg" style="width:80; height:80"> </div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="row box-input1 bg-light mx-auto">
            <div class="col-md-3">
              <p class="lead my-0">Goal:</p>
            </div>
            <div class="col-md-3">
              <p class="lead my-0">Funds:</p>
            </div>
            <div class="col-md-3">
              <p class="lead my-0">Start date:</p>
            </div>
            <div class="col-md-3">
              <p class="lead my-0">End date:</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
